...
export default class Books extends React.Component{
    ...
    render(){
        return (
            <div>
                <div>
                    书名:<input type="text" value={this.state.searchValue} onChange={this.inputChange.bind(this)} />
                    类别:<SearchSelected url="../../cate.json" analysis={this.analysisCate} cb={this.selectedCallback}/>
                    <br/>
